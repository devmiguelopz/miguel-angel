...
import { Film, Popcorn, Heart } from "lucide-react";
...
export default function InvitationPage() {
  ...
  const handleTicketClick = useCallback(() => {
    alert("¡Stitch verá la película contigo, Yameli!");
  }, []);
  ...
  return (
    ...
    >
      {/* Corazones grandes animados en esquinas */}
      {[
      ...
      {smallHearts.map((pos, i) => (
        ...
        >
          <motion.svg
            ...
            className="w-6 h-6 text-pink-400 opacity-50"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      >
        {/* Sección del póster con foto overlay */}
        <div className="relative flex flex-col">
          ...
          <div className="p-4">
            <div className="relative" style={{ paddingTop: "56.25%" }}>
              <iframe
                src="https://www.youtube.com/embed/9JIyINjMfcc"
        ...
        <div className="p-10 flex flex-col justify-between text-white">
          ...
          >
            ...
            >
              ...
              que compartimos, cada sonrisa tuya ilumina mi mundo. Acompáñame
              este jueves 22 de mayo a descubrir nuevas risas y abrazos viendo{" "}
              <span className="text-pink-400 font-semibold">Lilo & Stitch</span>
              , porque contigo cada película se convierte en magia eterna.
            </motion.p>
            ...
            >
              <Popcorn className="w-8 h-8 text-pink-300" />
              <Popcorn className="w-8 h-8 text-pink-300" />
              <Popcorn className="w-8 h-8 text-pink-300" />
            </motion.div>
          </motion.div>
